...
// Los textos traducidos o recortados conservan el original completo en
// `comentario_original` para referencia y verificación.
    ...
    const comentarios = [
        {
            ...
            tipo: "Tour Las Ánimas",
            comentario: "Todo excelente, el servicio excelente 10/10. Aprovechamos al máximo la barra libre, un trago tras otro. La comida se sirve en Las Ánimas; es buena y sabrosa. Nos atendió Monse. Muchísimas gracias, todo excelente.",
        ...
        },
        {
            ...
            calificacion: "⭐⭐⭐⭐⭐",
            fecha: "Febrero 2026",
            tipo: "Avistamiento de ballenas",
            comentario: "¡Excelente! Un tour precioso, vimos muchísimas ballenas. El equipo es muy profesional y atento. El catamarán no va sobrecargado de gente. ¡Todo estuvo hermoso!",
        ...
        },
        {
            ...
            calificacion: "⭐⭐⭐⭐⭐",
            fecha: "Enero 2026",
            tipo: "Tour en catamarán",
            comentario: "Todo el personal muy profesional y cálido. La comida que ofrecen también es de muy buena calidad. Una experiencia extraordinaria que sin duda repetiría.",
        ...
        {
            nombre: "Alexa",
            ciudad: "Hollywood, Florida",
            pais: "Tripadvisor",
            calificacion: "⭐⭐⭐⭐⭐",
            fecha: "Julio 2022",
            tipo: "Viaje en familia",
            comentario: "¡Increíble! Fue una experiencia buenísima y mi familia y yo la disfrutamos de verdad. Tengo una hija autista y un niño pequeño muy inquieto: fueron atentos, amables, serviciales y profesionales. Recomiendo esta empresa sin dudarlo y volvería con ellos. Pasamos un día maravilloso y nos sentimos seguros todo el tiempo.",
        ...
        },
        {
            ...
            comentario: "Disfruté muchísimo el tour en mis vacaciones con mis amigos. Fuimos a Los Arcos, Las Ánimas y Quimixto y estuvo increíble. Desde Francia, cuando planeábamos el viaje a México, decidimos reservar en el sitio web porque fue muy fácil. Fue muy divertido y nos integraron con todos.",
